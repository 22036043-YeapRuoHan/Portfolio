...
public class TravelController : Controller
{
    ...
    public IActionResult Details(int id)
    {
        ...
        // TODO: Lesson09 Task 2a - Make unsecure DB SELECT secure.
    ...
    // TODO: Lesson09 Task 7 - Add the admin and user roles to the [Authorize] attributes (6x)
    ...
    public IActionResult Create(Trip trip, IFormFile photo)
    {
        ...
        else
        {
            ...
            //TODO: Lesson09 Task 2b - Make insecure DB INSERT secure.
    ...
    public IActionResult Delete(int id)
    {
        ...
        string select = @"SELECT * FROM TravelHighlight 
                         WHERE id={0} AND UserId='{1}'";
        // TODO: Lesson09 Task 2e - Make insecure DB SELECT secure.
        //string sql = string.Format(select, id, userid);
