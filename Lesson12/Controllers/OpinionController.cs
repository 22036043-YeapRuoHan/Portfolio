...
{
    // TODO: Lesson12 Task 1 - Fill in your port number
    readonly string DOMAIN = Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT")!.Equals("Production") ?
        "c236lesson12pkrh.azurewebsites.net" : "localhost:38025";
    //readonly string DOMAIN = "localhost:38025";
    //                                  ^^^^^
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^'''''^^^^^^^^^
    // >>>>> Remember to change your port number <<<<<
    // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
