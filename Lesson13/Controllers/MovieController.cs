...
public class MovieController : Controller
{
    ...
    //TODO: Lesson13 Task 8 - Complete the EditMovie action 
    [HttpGet]
    [Authorize(Roles = "manager")]
    public IActionResult EditMovie(string id)
    {
        ...
        {
            ViewData["Genres"] = GetListGenres();
            // TODO: Lesson13 Task 8a - Return the first (and only) record 
            return View(lstMovie[0]); // This line needs modification 
        }
        else
        // Otherwise redirect to the movie list page 
        {
            // TODO: Lesson13 Task 8b - Set the TempData message and redirect to the movie list page 
    ...
    public IActionResult EditMovie(Movie movie)
    {
        ...
        string update = @"UPDATE Movie SET Title='{1}', ReleaseDate='{2:yyyy-MM-dd}', Price={3}, Duration={4}, Rating='{5}',GenreId={6} WHERE MovieId={0}";
        // TODO: Lesson13 Task 9 - Write the update statement. 
        int result =
           DBUtl.ExecSQL(update, movie.MovieId, movie.Title, movie.ReleaseDate, movie.Price, movie.Duration, movie.Rating, movie.GenreId);  // TODO: Lesson 13 Task 9c - Add arguments and execute the update statement. 
        if (result == 1)
        {
